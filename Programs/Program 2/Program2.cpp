...
int main() {
    ...
    int carRand = 0;
    // rand() % 4 + 1; rand() % 3 +1;
    // all rand variables are made just for me to make sense of them. 
    ...
    do {
        ...
        switch (firstAnswer) {
            ...
            // Turns the boolean false and ends the program
            case 2:
                runMash = false;
                cout << "\nYou chose to end the program." << endl;
                cout << "Bye!" << endl;
            break;
            // just a fail safe that is not needed at all but looks nice
            default:
